...
if os.path.exists('/Users/{}/Desktop/ShowStopper'.format(user)) is True:
	shutil.rmtree('/Users/{}/Desktop/ShowStopper'.format(user), ignore_errors=True)
...
while True:
	try:
		...
		print 'foo'
		urlretrieve('http://unsplash.it/2560/1600/?random', '/Users/{}/Desktop/ShowStopper/{}.jpeg'.format(user,name[:10]))
